...
class Calculator extends Component {
    ...
    setOperator = (e, name) => {
        console.log('this is the clicked operator:', e.target.name)
        ...
        <div className="container">
            ...
            <div className="calc-container">
                ...
                <div className="calc-row">
                    <button name="AC" className="calc-button calc-button-top" onClick={ (e) => this.setOperator(e, 'AC') } >AC</button>
                    <button name="+-" className="calc-button calc-button-top" onClick={ (e) => this.setOperator(e, '+-') }>+/-</button>
                    <button name="%" className="calc-button calc-button-top" onClick={ (e) => this.setOperator(e, '%') } >%</button>
                    <button name="/" className="calc-button calc-button-op"onClick={ (e) => this.setOperator(e, '/') } >/</button>
                </div>
                <div className="calc-row">
                    ...
                    <button name="x" className="calc-button calc-button-op" onClick={ (e) => this.setOperator(e, 'x') }>x</button>
                </div>
                <div className="calc-row">
                ...
                <div className="calc-row">
                    ...
                    <button name="." className="calc-button" onClick={ (e) => this.setOperator(e, '.') } >.</button>
                    <button name="=" className="calc-button calc-button-op" onClick={ (e) => this.setOperator(e, '=') }>=</button>
                </div>
            </div>
        </div>
